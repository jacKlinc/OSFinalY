...
the block to the screen.  Implement these two programs with and without semaphore protection and observe the difference in operation.  
Run the first program as a background process with “&” so as to allow you to later launch the second program from the keyboard.   
