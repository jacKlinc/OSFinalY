...
int main()
{
    ...
    *readerCount = 0;
    ...
    psembuf.sem_op=-1;                              // what value to use with semop
    psembuf.sem_flg=SEM_UNDO;                       // SEM_UNDO makes kernel increment for process after decrementing semap
    vsembuf.sem_num=0;
    vsembuf.sem_op=1;
    ...
    while(1){
        ...
        *readerCount++;
        ...
        semop(semid, &psembuf, 1);                  // lock reader mutex, can use readerCount
        *readerCount--;                                                         
    ...
    // the purpose of the SEM_UNDO, to ensure that if a process exits after decrementing a semaphore
